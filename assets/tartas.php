...
// Filtramos los productos de la tabla "tartas" para solo tomar los que su stock sea mayor a 0
$products = [];
$result = $mysqli->query("SELECT id, nombre, precio, stock FROM tartas WHERE stock > 0 LIMIT $offset, $productos_por_pagina");
