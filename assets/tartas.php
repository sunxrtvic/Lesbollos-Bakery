...
// Tomamos los productos de la tabla "tartas" con limitación
$products = [];
$result = $mysqli->query("SELECT id, nombre, precio, stock FROM tartas LIMIT $offset, $productos_por_pagina");
...
$total_resultados = $mysqli->query("SELECT COUNT(*) as total FROM tartas")->fetch_assoc()['total'];
