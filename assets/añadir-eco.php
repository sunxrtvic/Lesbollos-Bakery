...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nombre) || empty($precio) || empty($stock)) {
        ...
        $stmt = $mysqli->prepare("INSERT INTO eco (nombre, precio, stock) VALUES (?, ?, ?)");
...
<body>
    ...
    <form class="contenedor-perfil" method="POST" action="añadir-eco.php">
        <h1>Añadir nuevo producto Eco</h1>
