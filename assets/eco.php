...
<html>
    <head>
        ...
        <main>
            <section>
                <section>
                    <h1 style="font-family: 'Dosis', sans-serif;">Nuestros Productos Ecológicos</h1>
                        <hr>
                        <section id="grid">
                            <article>
                                <img src="./imagenes/eco/foto1.jpg">
                                <h2>Producto 1</h2>
                            ...
                            <article>
                                <img src="./imagenes/eco/foto2.jpg">
                                <h2>Producto 2</h2>
                                <p class ="subtitulo">MAGNICA KICTAN - LOREMIPSUM</p>
                                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Et consequuntur, blanditiis ullam placeat architecto,
                                     voluptate quaerat ipsam natus sed voluptatibus, magnam soluta qui facilis animi quibusdam voluptas ducimus eligendi?
                            ...
                            <article>
                                <img src="./imagenes/eco/foto3.jpg">
                                <h2>Producto 3</h2>
                                <p class ="subtitulo">MAGNICA KICTAN - LOREMIPSUM</p>
                                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Et consequuntur, blanditiis ullam placeat architecto,
                                     voluptate quaerat ipsam natus sed voluptatibus, magnam soluta qui facilis animi quibusdam voluptas ducimus eligendi?
                            ...
                            <article>
                                <img src="./imagenes/eco/foto4.jpg">
                                <h2>Producto 4</h2>
